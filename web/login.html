           ...
           <nav class="absolute transparent">
                <div class="nav-bar">
                    <div class="module left">
                        <a href="index.html">
                            <img class="logo logo-light" alt="Ripple Networks" src="img/logo-light.png">
                            <img class="logo logo-dark" alt="Ripple Networks" src="img/logo-dark.png">
                        </a>
                    </div>
                    ...
                    <div class="module-group right">
                            ...
                            <ul class="menu">
                                <li class="has-dropdown">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="about-us.html#leadership">
                                                Leadership
                                            </a>
                                        </li>
                                        <li>
                                ...
                                <li class="has-dropdown">
                                    <a href="technology-overview.html">
                                        Technology
                                    </a>
                                    <ul>
                                        <li>
                        ...
                        <div class="module widget-handle language left">
                            <ul class="menu">
                                <li>
                                    <a href="login.html">Customer Log In</a>
                                </li>
                            </ul>
                        </div>
                    </div>
