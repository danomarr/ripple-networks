                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <h5 class="uppercase mb32"><strong>Native Internet Video Offerings</strong></h5>
                                        ...
                                        <div class="tab-content">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                        <div class="feature feature-2">
                                                            <div class="text-left">
                                                                <h4 class="">Ad Support OTT</h4>
                                                                
                                                                <p>
                                                                    Ripple allows an MSO to extend the capacity of their network to offer full live, linear, and VOD services across the globe with the equivalent quality, reliability, and low latency as your fully managed network over the open Internet. Ripple delivers the highest quality even in high traffic periods.
                                                                </p>                                                            </div>
                                                        </div> 
                                                    </div>   
                                                <div class="col-sm-8">
                                                            ...
                                                            <table class="table table-condensed table-bordered">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                        Have full readout of data like you managed network over the open internet.
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                        Full analytics readout on a per user basis including advertising and usage behavior.
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                        Works with state-of-the-art and emerging targeted ad insertion systems.
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                        Works with Geo-blocking schemes  
                                                                        </td>
                                                                        <td>
                                                                        Preserves contractual integrity
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                        Works seamlessly with current workflow and CDN
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                ...
                                                <div class="col-sm-4">
                                                        <div class="feature feature-2">
                                                            <div class="text-left">
                                                                ...
                                                                <p>
                                                                    Ripple provides state-of-the art video distribution services rivaling the quality and reliability of managed MSO networks and over-the-air reception with the capability of reaching mass concurrent audiences on tablets, phones, OTT boxes  and connected TVs.
                                                                    </p>                                                            
                                                                </div>
                                                        </div> 
                                                    </div>   
